...
$string['messagesbetween'] ='Messages between ';
...
$string['morethanoneblockedusers']=' blocked users';
$string['morethanoneincomingcontact']=' incoming contacts';
$string['morethanoneofflinecontact']=' offline contacts';
$string['morethanoneonlinecontact']=' online contacts';
$string['morethanonemessage']=' unread messages';
$string['newonlymsg'] = 'Show only new';
$string['newsearch'] = 'New search';
$string['noframesjs'] = 'Use more accessible interface';
$string['assistivetechnology'] = 'If you are using assistive technology click here to use more accessible interface';
...
$string['oneblockeduser']=' one blocked user';
$string['oneunreadmessage'] = ' unread message';
$string['oneofflinecontact']=' offline contact';
$string['oneincomingcontact']=' incoming contact';
$string['oneonlinecontact']=' online contact';
